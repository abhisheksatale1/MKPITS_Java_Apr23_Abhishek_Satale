    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String userid = httpsession.getAttribute("u_id").toString();
        ...
        String Transationtype= "Deposit";
            ...
            PreparedStatement prepareUpdateStatement= connection.prepareStatement("update Transactions set balance=balance+? where user_id=?");
            prepareUpdateStatement.setInt(2,Amount);
            prepareUpdateStatement.setString(1, userid);
           int resultUpdateSet = preparedStatement.executeUpdate();
